...
public abstract class UsersServiceBase : IUsersService
{
    ...
    public UsersServiceBase(AaaDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<User> UserLogin(UserCreateInput userCreateInputDto)
    {
        throw new NotImplementedException();
    }

    public async Task<User> UserRegistration(UserCreateInput userCreateInputDto)
    {
        throw new NotImplementedException();
    }
